...
fr.Avatar = cc.Node.extend({
    ctor: function (defaultAvatar) {
        ...
        this._defaultAvatar = new cc.Sprite(defaultAvatar);//, this, 0, 0, 0.5, 0.5);
    ...
    updateAvatar : function(url)
    {
        ...
        if (url.indexOf("zdn.vn") >= 0 || Config.ENABLE_CHEAT){
            return;
        }
        // if(_.isEmpty(url))
        // {
    ...
    {
        return jsb.fileUtils.getWritablePath() + md5(url) + ".png";
    },
