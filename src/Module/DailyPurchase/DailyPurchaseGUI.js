            ...
            this.giftCell.runAction(cc.sequence(
                ...
                cc.callFunc(function(){
                    if (gift.gold > 0){
                        ...
                        effectMgr.runLabelPoint(lobby._uiBean, userMgr.getGold() - gift.gold, userMgr.getGold(), 0.75, null, true);
                    }
                    if (gift.vPoint > 0){
                    ...
                    if (gift.diamond > 0){
                        ...
                        effectMgr.runLabelPoint(lobby._uiDiamond, userMgr.getDiamond() - gift.diamond, userMgr.getDiamond(), 0.75, null, false);
                    }
