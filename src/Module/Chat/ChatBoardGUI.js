...
var ChatPanelGUI = BaseLayer.extend({
    ctor: function(){
        ...
        this.initWithBinaryFileAndOtherSize("ChatPanelGUI.json", cc.size(800, 480));
    ...
    initGUI: function(){
        ...
        if (this._scale < 1) this.bg.setScale(this._scale);
            ...
            this.bg.setContentSize(this._layout.getContentSize().width, this.bg.getContentSize().height);
    ...
    tableCellTouched: function(table, cell){
        ...
        if (chatInfo.uId == userMgr.getUID()){
            ...
            gui.setInfo(userMgr.getUserInfo());
            this.onBack();
        }
        else {
...
var ChatItemCell = cc.TableViewCell.extend({
    ...
    setInfo: function(chatInfo){
        ...
        this.txtName.setColor(chatInfo.uId == userMgr.getUID() ? sceneMgr.ccBlue : sceneMgr.ccYellow);
...
var ChatQuickTextPanel = cc.Class.extend({
    ctor: function(_layout, panel){
        ...
        this.tbTxt.setVerticalFillOrder(cc.TABLEVIEW_FILL_TOPDOWN);
