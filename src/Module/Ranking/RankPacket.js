...
var CmdSendGetRankConfig = CmdSendCommon.extend({
    ctor:function()
    {
        ...
        this.setCmdId(RankData.CMD_GET_RANK_CONFIG);
...
var CmdSendGetMyRankInfo = CmdSendCommon.extend({
    ctor:function()
    {
        ...
        this.initData(100);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_GET_RANK_INFO_USER);
...
var CmdSendGetOtherRankInfo = CmdSendCommon.extend({
    ctor:function()
    {
        ...
        this.initData(100);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_RANK_INFO_OTHER_USER);
    },
...
var CmdSendGetWeekRank = CmdSendCommon.extend({
    ctor:function()
    {
        ...
        this.initData(100);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_LIST_RANK_INFO_IN_WEEK);
    },
...
var CmdSendGetTopUsers = CmdSendCommon.extend({
    ctor: function () {
        ...
        this.initData(1000);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_GET_TOP_USERS);
    },
...
var CmdSendPingpongRank = CmdSendCommon.extend({
    ctor: function () {
        this._super();
        this.initData(1000);
        this.setControllerId(0);
        this.setCmdId(RankData.CMD_PINGPONG);
        this.putData();
    },
...
var CmdSendConfirmResultLastWeek = CmdSendCommon.extend({
    ctor: function () {
        ...
        this.initData(1000);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_GIFT_LAST_WEEK);
        this.putData();
    },
...
var CmdSendConfirmTruCup = CmdSendCommon.extend({
    ctor: function () {
        ...
        this.initData(1000);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_SUB_CUP_OFFLINE);
        this.putData();
    },
...
var CmdSendCheatRankInfo = CmdSendCommon.extend({
    ctor: function () {
        this._super();
        this.initData(1000);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_CHEAT_INFO);
    },

    putData: function (cup, goldMedal, silverMedal, bronzeMedal) {
        cc.log("CmdSendCheatRankInfo: ", cup, goldMedal, silverMedal, bronzeMedal);
        this.packHeader();
        this.putInt(cup);
...
var CmdSendCheatGoldWin = CmdSendCommon.extend({
    ctor: function () {
        ...
        this.initData(1000);
        this.setControllerId(1);
        this.setCmdId(RankData.CMD_CHEAT_GOLD_WIN);
    },
