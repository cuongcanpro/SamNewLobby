var RankResultGUI = BaseLayer.extend({
    ctor: function () {
        this._super();
        this.initWithBinaryFile("RankLastWeekResult.json");
        this.typeMedal = -1;
    },
    ...
    initGUI: function () {
        ...
        this.infoWin = new RankPersonalInfoCell(true);
        ...
        this.customButton("btnReceive", RankResultGUI.BTN_RECEIVE_NOW);
        ...
        this.infoNoWin = new RankPersonalInfoCell(true);
        ...
        this.btnUnderstood = this.customButton("btnUnderstood", RankResultGUI.BTN_UNDER_STOOD);
    },
    ...
    updateResult: function (dataLastWeek) {
        ...
        var diamond = RankData.getDiamondByPackId(packId);
        var item = RankData.getItemByPackId(packId);
    ...
    updateMedal: function (dataLastWeek) {
        ...
        if (this.typeMedal > -1) {
            ...
            this.medal.loadTexture(imgMedal, ccui.Widget.LOCAL_TEXTURE);
        }
    ...
    onButtonRelease: function () {
        ...
        if (!this.isTypeTruCup) {
            ...
            RankGameClient.getInstance().sendPacket(confirm);
            RankData.getInstance().setDataResultLastWeek(null);
            ...
            if (!isLose) {
                ...
                if (gui && gui instanceof LobbyScene) {
                    ...
                    var diamond = RankData.getDiamondByPackId(dataLastWeek["packId"]);
            ...
            RankData.getInstance().setDataTruCup(null);
            confirm = new CmdSendConfirmTruCup();
            RankGameClient.getInstance().sendPacket(confirm);
        }
        RankData.getInstance().setNumberOldCup(numOldCup);
    ...
    actionMoveCup: function (isLose, numberCup) {
        var guiRank = sceneMgr.getGUI(RankGUI.TAG);
...
RankResultGUI.className = "RankResultGUI";
RankResultGUI.TAG = 51;
RankResultGUI.BTN_RECEIVE_NOW = 1;
RankResultGUI.BTN_UNDER_STOOD = 2;