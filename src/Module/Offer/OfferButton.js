...
var OfferButton = cc.Node.extend({
    ctor: function () {
        this._super();
        var anim = db.DBCCFactory.getInstance().buildArmatureNode("iconBottom");
        ...
        this.lbTime = new ccui.Text("", SceneMgr.FONT_NORMAL, 16);
        ...
        this.lbTime.setPosition(0, -this.btn.getContentSize().height * 0.55);
       ...
       // this.lbTime.enableOutline(cc.color(131, 73, 52), 1);
        ...
        var anim = db.DBCCFactory.getInstance().buildArmatureNode("iconTop");
        anim.gotoAndPlay("1", -1, -1, 0);
        this.addChild(anim);
    },
