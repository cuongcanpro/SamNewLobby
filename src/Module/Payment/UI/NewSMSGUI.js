...
//        this.tabSMS.setItemType(Payment.GOLD_SMS_VIETTEL);
    ...
    autoSelectTab: function(){
        ...
        var targetTab = 0;
        for (var i = 6; i < paymentMgr.arrayShopGoldConfig.length; i++){
        ...
        var buttonId = -1;
        var config = paymentMgr.arrayShopGoldConfig[targetTab];
    ...
    onButtonRelease: function (btn, id) {
        switch (id) {
            ...
            case NewSMSGUI.BTN_VINA:
            {
                ...
                var config = paymentMgr.getShopGoldById(itemType);
    ...
    autoSelectTabNotMaintain: function () {
        for (var i = Payment.GOLD_SMS_VIETTEL; i <= Payment.GOLD_SMS_VINA; i++){
            var config = paymentMgr.getShopGoldById(i);
            if (config && config["isMaintained"][0] === 0) {
