...
var BlueOceanAccumulateGUI = BaseLayer.extend({
    ...
    showAccumulate: function (cmd) {
        ...
        this.progress.runAction(cc.sequence(new cc.EaseBackOut(cc.moveTo(BO_ACCUMULATE_TIME_MOVE, cc.p(cc.winSize.width,this.progress.defaultPos.y))), cc.callFunc(this.endMoving.bind(this))));
