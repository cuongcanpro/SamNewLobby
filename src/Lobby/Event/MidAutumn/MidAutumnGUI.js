...
var MidAutumnAccumulateGUI = BaseLayer.extend({
    ...
    effectLight: function () {
        try {
            for (var i = 0; i < parseInt(Math.random() * 100) % 10 + 10; i++) {
                ...
                var actMove = cc.bezierTo(timeBubble, [this.startPos, this.midPos, endPos]);
    ...
    showAccumulate: function (cmd) {
        ...
        this.progress.runAction(cc.sequence(new cc.EaseBackOut(cc.moveTo(MD_ACCUMULATE_TIME_MOVE, cc.p(cc.winSize.width,this.progress.defaultPos.y))), cc.callFunc(this.endMoving.bind(this))));
        ...
        if (this.result.keyCoinAward > 0) {
            ...
            var spawn1 = cc.spawn(new cc.EaseSineOut(cc.moveTo(0.5, this.coin.posDes)), cc.scaleTo(0.5, 0.3));
