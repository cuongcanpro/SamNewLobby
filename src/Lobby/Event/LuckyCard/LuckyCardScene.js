...
var moveLeft = function (sp) {
    ...
    return cc.sequence(cc.delayTime(delay), cc.EaseBackOut(cc.moveTo(timeMove, cc.p(-_size.width, sp.getPositionY()))), func);
};
...
var moveRight = function (sp) {
    ...
    return cc.sequence(cc.delayTime(delay), cc.EaseBackOut(cc.moveTo(timeMove, cc.p(cc.winSize.width + _size.width, sp.getPositionY()))), func);
};
...
var LuckyCardScene = BaseLayer.extend({
    ...
    playEfxNemXu: function () {
        ...
        var bezierTo = cc.bezierTo(timeMove, bezier);
    ...
    efxFreeCoin: function () {
        if (!this.freeCoin) {
            ...
            var bezierTo = cc.bezierTo(0.55, bezier);
            ...
            if (this.cmdResult.gifts.length > 1) {
                ...
                this.runAction(cc.sequence(
                    ...
                    cc.callFunc(function () {
                        ...
                        var icon = this.getControl("icon", this.lbCoin.getParent());
    ...
    onFinishEffectPhysics: function () {
        ...
        for (var i = 0; i < this.effSprites.length; i++) {
            ...
            if (this.goldPos) {
                ...
                sp.runAction(cc.sequence(cc.delayTime(time), cc.spawn(cc.scaleTo(0.25, 0.5), cc.fadeTo(0.25, 25), cc.bezierTo(0.25, bezier)), cc.sequence(cc.scaleTo(0.1, 1), cc.scaleTo(0.05, 0.1)), cc.removeSelf()));
            }
        }
...
var LuckyCardAccumulateGUI = BaseLayer.extend({
    ...
    showAccumulate: function (cmd) {
        ...
        this.progress.runAction(cc.sequence(
            new cc.EaseBackOut(cc.moveTo(LuckyCardAccumulateGUI.TIME_MOVE, this.progress.defaultPos)),
    ...
    onCloseGUI: function () {
        ...
        if (this.isAllShow) {
            ...
            this.progress.runAction(cc.EaseBackIn(moveTo));
        } else {
            this.progress.runAction(cc.sequence(new cc.EaseBackIn(moveTo), cc.callFunc(this.onClose.bind(this))));
        }
