...
var SupportBeanGUI = BaseLayer.extend({
    ...
    onEnterFinish: function () {
        ...
        let titleBgDelay = 1500;
        let titleCatDelay = 1500;
    ...
    showSupportBean: function (money, numSupport) {
        this.money = money;
        this.loadInfo("Congratulations/imgGold.png", LocalizedString.to("SUPPORT_GOLD_EACH_DAY"), money);
    },
