...
var EggBreakerScene = BaseLayer.extend({
    ...
    onButtonRelease: function (btn, id) {
        ...
        switch (id) {
            ...
            {
                gamedata.openShop(EggBreakerScene.className);
                break;
            }
...
// thong bao tang ve khi mua gold trong Shop
var EggBreakerNotifyGUI = BaseLayer.extend({

    ctor: function () {
        this.lbTime = null;

        this._super(EggBreakerNotifyGUI.className);
        this.initWithBinaryFile("res/Lobby/GUIEggBreakerNotify.json");
    },

    initGUI: function () {
        this._bg = this.getControl("bg");

        this.customButton("btnClose", EggBreakerNotifyGUI.CLOSE, this._bg);
        this.btnCheckBox= this.customButton("btnCheckBox", EggBreakerNotifyGUI.CHECK_BOX, this._bg);
        this.iconSelect = this.getControl("iconSelect", this.btnCheckBox);
    ...
    onButtonRelease: function (btn, id) {
        // MidAutumnSound.playBubbleSingle();
        if (id == EggBreakerNotifyGUI.CLOSE) {
            this.onCloseDone();
        }
        else if (id == EggBreakerNotifyGUI.CHECK_BOX) {
            this.iconSelect.setVisible(!this.iconSelect.isVisible());
            cc.sys.localStorage.setItem("eggBreakerNotShowNotify", this.iconSelect.isVisible() ? "1" : "0");
        }
    },
...
EggBreakerNotifyGUI.className = "EggBreakerNotifyGUI";
EggBreakerNotifyGUI.TAG = 1019;
EggBreakerNotifyGUI.CHECK_BOX = 0;
EggBreakerNotifyGUI.CLOSE = 1;
