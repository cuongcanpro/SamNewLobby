...
var ShopIapScene = BaseLayer.extend({
    ...
    reLayoutTab: function () {
        ...
        if (arrayConfigTicket.length > 0 && false) {
...
var ZingCardPanel = BaseLayer.extend({
    ...
    initGUI: function () {
        ...
        this.pEventBonus.loadTexture("Lobby/Event/event_bonus_card.png");
    ...
    updateInfo: function () {
        this.pEventBonus.setVisible(Config.ENABLE_EVENT_SECRET_TOWER && secretTower.isInEvent());
    },
