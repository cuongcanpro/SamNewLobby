...
var OfferData = cc.Class.extend({
    ...
    getConfigOffer: function () {
        try {
            ...
            var min = 1000000000;
            if (this.isNoPrice()) {
                var config = gamedata.gameConfig.getShopGoldById(this.convertOfferPayment());
                if (config) {
    ...
    getLastBuy: function () {
        ...
        var id = gamedata.gameConfig.getLastShopGoldId();
    ...
    reloadOffer: function () {
        ...
        for (var i = 0; i < this.arrayOffer.length; i++) {
            ...
            if (gamedata.gameConfig) {
                config = gamedata.gameConfig.getShopGoldById(offer.convertOfferPayment());
            } else {
                offer.offerId = -1;
                return;
            }
