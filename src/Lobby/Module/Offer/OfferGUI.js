...
//         this.arrayOffer = [];
//         this.bg = this.getControl("bg");
//         this.btnReceive = this.customButton("btnReceive", GUISupportInfo.BTN_OK);
//         this.btnClose = this.customButton("btnClose", GUISupportInfo.BTN_CLOSE);
//         this.btnClose2 = this.customButton("btnClose2", GUISupportInfo.BTN_CLOSE);
//         this.btnBuy = this.customButton("btnBuy", GUISupportInfo.BTN_BUY);
//         this.lbNotice = this.getControl("lbNotice", this.bg);
//
//         this._moneyGroup = new NumberGroup();
//         this.bg.addChild(this._moneyGroup);
//         this._moneyGroup.setPosition(this.bg.getContentSize().width * 0.5, 30);
//         this._moneyGroup.setScale(0.8);
//         this.getControl("imgGold").setVisible(false);
//         this.enableFog();
//     },
//
//     onEnterFinish: function() {
...
//     },
//
//     showGUI: function (money, numSupport) {
//         if (money > 0) {
//             this._moneyGroup.setNumber(money);
//             this.lbNotice.setVisible(true);
//             if (gamedata.numSupport == 0)
//                 this.lbNotice.setString(LocalizedString.to("SUPPORT_MONEY3"));
//             else if (gamedata.numSupport == 1)
//                 this.lbNotice.setString(LocalizedString.to("SUPPORT_MONEY1"));
//                 // else if (gamedata.numSupport == 2)
//             //     this.lbNotice.setString(LocalizedString.to("SUPPORT_MONEY1"));
//             else
//                 this.lbNotice.setString("");
//             this.btnReceive.setVisible(true);
...
//                 //if (gamedata.numSupport <= 0) {
//                 this.lbNotice.setString(LocalizedString.to("SUPPORT_INFO_1"));
...
//             }
//             else {
//                 // chua du dieu kien nhan Gold
//                 this.lbNotice.setString(LocalizedString.to("SUPPORT_INFO_2"));
//                 this.btnBuy.setVisible(false);
//                 this.btnReceive.setVisible(false);
//                 this.btnClose.setVisible(true);
//
...
//             }
//             // so tien the hien la so tien cao nhat co the nhan
//             if (gamedata.userData.typeVip > 0) {
//                 this._moneyGroup.setNumber(gamedata.gameConfig.vipConfig[gamedata.userData.typeVip].support[0]);
//             }
//             else {
//                 this._moneyGroup.setNumber(30000);
//             }
//         }
//     },
//
...
// })
//
// GUISupportInfo.BTN_OK = 0;
// GUISupportInfo.BTN_BUY = 1;
// GUISupportInfo.BTN_CLOSE = 2;
// GUISupportInfo.tag = 1002;
// GUISupportInfo.className = "GUISupportInfo";
