...
var FBetRate = BaseLayer.extend({
    ...
    initGUI : function () {
        ...
        this.lbBetMin.setString(LocalizedString.to("MIN") + " : " + StringUtility.pointNumber(gamedata.gameConfig.miniGame.minBet));
        this.lbBetMax.setString(LocalizedString.to("MAX") + " : " + StringUtility.pointNumber(gamedata.gameConfig.miniGame.maxBet));
    },
    ...
    onAcceptBet : function () {
        var minBet = gamedata.gameConfig.miniGame.minBet;
        var maxBet = gamedata.gameConfig.miniGame.maxBet;
    ...
    checkMoney : function () {
        ...
        if(num > gamedata.gameConfig.miniGame.maxBet)
        {
            num = gamedata.gameConfig.miniGame.maxBet;
            var s = LocalizedString.to("NOTE_2");
