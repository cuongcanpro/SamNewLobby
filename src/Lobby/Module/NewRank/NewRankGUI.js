var NewRankGUI = BaseLayer.extend({
    ...
    onButtonRelease: function (btn, id) {
        switch (id) {
            ...
            case NewRankGUI.BTN_TOP:
                ...
                this.bgTableRank.loadTexture("bgTopRank.png", ccui.Widget.PLIST_TEXTURE);
    ...
    tableCellSizeForIndex: function(table, idx){
        ...
        var bg = new ccui.ImageView(bgTexture, ccui.Widget.PLIST_TEXTURE);
...
var NewRankPersonalInfoCell = cc.TableViewCell.extend({
    ...
    updateInfo: function (data, size, weekLevel, isTopRank) {
        ...
        this.bg.loadTexture(textureBg, ccui.Widget.PLIST_TEXTURE);
        if (!this.isMiniRank){
            this.pReward.loadTexture(textureReward, ccui.Widget.PLIST_TEXTURE);
