...
ChatMgr.playChatEffect = function(index, message){
    ...
    switch(index){
        case 0: //self
            ...
            node.setPosition(avatarPos.x + 50 * _scale, avatarPos.y + 65 * _scale);
            break;
        case 1:
            ...
            node.setPosition(avatarPos.x - 120 * _scale, avatarPos.y);
            break;
        case 2:
            ...
            chatBg.setPosition(Math.min(chatBg.getContentSize().width, 15), -arrow.getContentSize().height * arrow.getScale());
            node.setPosition(avatarPos.x, avatarPos.y - 70 * _scale);
            break;
        case 3:
            arrow.setRotation(180);
            arrow.setPosition(0, -arrow.getContentSize().height * arrow.getScale()/2);
