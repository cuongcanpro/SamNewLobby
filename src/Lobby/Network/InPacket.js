...
else
{
    ...
    engine.InPacket = cc.Class.extend({
        ...
        getString: function () {
            ...
            return decodeURIComponent(escape(encode));
        },
        clean: function(){
...
CmdReceivedConfig = CmdReceivedCommon.extend({
    ...
    readData: function () {
        ...
        this.syntaxSms = this.getString();
        this.paymentType = this.getInt();
        this.enableSMS = this.getBool();
        this.enableCard = this.getBool();
        this.smsType = this.getInt();
...
CmdReceiveUpdateBuyGold = CmdReceivedCommon.extend({
    ...
    readData: function () {
        this.numberBuyGold = this.getInt();
...
CmdReceiveVoteAppBonus = CmdReceivedCommon.extend({
    ctor :function(pkg)
    {
        this._super(pkg);
        this.readData();
...
CmdReceivedDID = CmdReceivedCommon.extend({
    ctor: function (pkg) {
        this._super(pkg);
        this.readData();
    },
    readData: function () {
        this.did = this.getString();
    }
});
...
CmdReceivedLevelUp = CmdReceivedCommon.extend({
    ...
    readData: function() {
        ...
        this.oldLevelExp = this.getDouble();
        this.newLevelExp = this.getDouble();
    }
});
