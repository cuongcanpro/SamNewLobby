...
var game_sounds = {
    chatantien: "res/sounds/mp3/antienchat.mp3",
    chat: "res/sounds/mp3/chat.mp3",
    chiabai: "res/sounds/mp3/chiabai.mp3",
    dkthoat: "res/sounds/mp3/clickthoatra.mp3",
    chonquanbai: "res/sounds/mp3/clickvaoquanbai.mp3",
    danhbai: "res/sounds/mp3/danhbai.mp3",
    fire1: "res/sounds/mp3/e_fire1.mp3",
    fire2: "res/sounds/mp3/e_fire2.mp3",
    jackpot: "res/sounds/mp3/e_Jackpot.mp3",
    thua: "res/sounds/mp3/e_Lose.mp3",
    chupanh: "res/sounds/mp3/e_ScreenShot.mp3",
    start1: "res/sounds/mp3/e_Start.mp3",
    start2: "res/sounds/mp3/e_Start2.mp3",
    timer: "res/sounds/mp3/e_Timer.mp3",
    thang: "res/sounds/mp3/e_Win.mp3",
    huythoat: "res/sounds/mp3/huythoat.mp3",
    enemysanhtoicot: "res/sounds/mp3/ngkhacdanhsanhtoicot.mp3",
    nguoikhacvaoban: "res/sounds/mp3/nguoikhacvaoban.mp3",
    nhacbai: "res/sounds/mp3/nhacbobai.mp3",
    sanhtoicot: "res/sounds/mp3/sanhtoicot.mp3",
    thoatban: "res/sounds/mp3/thoatban.mp3",
    trutien: "res/sounds/mp3/trutienphat.mp3",
    vaoban: "res/sounds/mp3/vaoban1.mp3",
    popup: "res/sounds/mp3/e_Popup.mp3",
    result: "res/sounds/mp3/e_Result.mp3",
    click: "res/sounds/mp3/ButtonClick.mp3",
    xepbai: "res/sounds/mp3/e_Tap.mp3"
};
